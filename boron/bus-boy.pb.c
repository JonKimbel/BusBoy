...
const pb_field_t busboy_api_Response_fields[6] = {
    ...
    PB_FIELD(  2, MESSAGE , REPEATED, CALLBACK, OTHER, busboy_api_Response, arrival, time, &busboy_api_Arrival_fields),
    PB_FIELD(  3, MESSAGE , REPEATED, CALLBACK, OTHER, busboy_api_Response, route, arrival, &busboy_api_Route_fields),
    PB_FIELD(  4, MESSAGE , REPEATED, CALLBACK, OTHER, busboy_api_Response, temporary_message, route, &busboy_api_TemporaryMessage_fields),
